...
func TestUpdateService(t *testing.T) {
	...
	envService := &mockEnvironmentService{}
	...
	t.Run("update flake with invalid directory", func(t *testing.T) {
	...
	t.Run("apply configuration with invalid directory", func(t *testing.T) {
		err := service.ApplyConfiguration("/nonexistent/dir", true)
		if err == nil {
			t.Error("Expected error for nonexistent directory")
		}
	})
